                        ...
                        <template slot-scope="scope">
                            <el-dropdown trigger="click">
                                ...
                                <el-dropdown-menu slot="dropdown">
                                    <el-dropdown-item><span @click="editClick(scope.row)">编 辑</span></el-dropdown-item>
                                    <el-dropdown-item><span @click="detailClick(scope.row)">详 情</span></el-dropdown-item>
                                    <el-dropdown-item><span @click="deleteClick(scope.row.equiptId)">删 除</span></el-dropdown-item>
                                </el-dropdown-menu>
                            </el-dropdown>
                        </template>
                    </el-table-column>
...
import { timestampToDate, transformState } from '@/public/util';
export default {
    components: {
        DialogInfo
    },
